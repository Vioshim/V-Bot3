...
class UltraBeastCharacter(Character):
    ...
    async def upsert(self, connection: Connection):
        ...
        connection : Connection
            asyncpg connection
        """
        await self.standard_upsert(connection, kind="ULTRA BEAST")
