...
MAP_ELEMENTS = [
    ...
    MapPair(
        ...
        role=956973712974962759,
        lat=34,
        lon=58,
        emoji="\N{HOSPITAL}",
        short_desc="",
        desc="A very large hospital which is quite ready to handle most of the needs from all its citizens, to the tiniest joltik to even the needs of a wailord, this place overall is the most effective healing center that you can ever find.",
        image="",
    ),
    MapPair(
        name="Parvi",
